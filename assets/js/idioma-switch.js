...
const translations = {
    ...
    servicios_subtitulo: "Descubre <span class=\"naranja\">nuestros servicios</span> de energía renovable",
    servicio_fotovoltaica_titulo: "Instalación Fotovoltaica",
    servicio_fotovoltaica_desc: "Ofrecemos sistemas de paneles solares personalizados para hogares y empresas, optimizados para la eficiencia y el ahorro.",
    servicio_aerotermia_titulo: "Aerotermia",
    servicio_aerotermia_desc: "Soluciones de aerotermia para calefacción y refrigeración eficientes, aprovechando la energía del aire para reducir el consumo.",
    servicio_calefaccion_titulo: "Calefacción",
    servicio_calefaccion_desc: "Instalamos sistemas de calefacción ecológicos y económicos, adaptados a las necesidades de cada espacio.",
    servicio_mantenimiento_titulo: "Mantenimiento",
    servicio_mantenimiento_desc: "Ofrecemos planes de mantenimiento preventivo y correctivo para asegurar el rendimiento óptimo de tus instalaciones energéticas.",
    servicio_asesoramiento_titulo: "Asesoramiento",
    servicio_asesoramiento_desc: "Brindamos asesoramiento experto para ayudarte a tomar decisiones informadas sobre tus necesidades energéticas.",
    satisfechos_titulo: "Clientes Satisfechos",
    experiencia_titulo: "Años de experiencia",
    sostenibilidad_titulo: "Compromiso con la sostenibilidad",
    proyectos_titulo: "Proyectos completados por mes",

    // sobre-nosotros.html
    sobre_titulo_pagina: "BefEnergy - Sobre nosotros",
    sobre_titulo: "Sobre nosotros",
    sobre_subtitulo: "Soluciones <span class=\"naranja\">sostenibles y eficientes</span> con compromiso e innovación.",
    ...
    contacto_facil_titulo: "Contáctanos fácilmente",
    contacto_correo_titulo: "Correo electrónico",
    contacto_correo_email: "admin@befenergy.com",
    contacto_telefono_titulo: "Teléfono",
    contacto_telefono_num: "+34 93 131 56 36",
    contacto_direccion_titulo: "Dirección",
    contacto_direccion_texto: "Carrer d'Itàlia, 2, nau 2,<br>08700 Igualada, Barcelona",
    contacto_horario_titulo: "Horario",
    contacto_horario_lunes: "Lunes a Viernes:",
    contacto_horario_semana: "7:00 – 13:00 | 15:00 – 17:00",
    contacto_horario_sabados: "Sábados y Domingos:",
    contacto_horario_cerrado: "Cerrado",
    contacto_prefieres_correo: "¿Prefieres enviarnos un correo?",
    contacto_btn_cliente: "Usar cliente de correo",
    contacto_btn_gmail: "Abrir Gmail",
    contacto_siguenos: "¡Síguenos en las redes sociales!",
    // presupuesto-contacto.html  
    presupuesto_contacto_titulo: "BefEnergy - Presupuesto",
    presupuesto_contacto_hero_titulo: "Solicita tu presupuesto",
    presupuesto_contacto_hero_subtitulo: "Te ayudamos a encontrar la mejor solución energética para ti.",
    presupuesto_contacto_form_titulo: "Formulario de Presupuesto",
    presupuesto_contacto_form_nombre: "Nombre",
    presupuesto_contacto_form_apellidos: "Apellidos",
    presupuesto_contacto_form_email: "Correo electrónico",
    presupuesto_contacto_form_telefono: "Teléfono",
    presupuesto_contacto_form_servicio: "Servicio de interés",
    presupuesto_contacto_form_servicio_placeholder: "Selecciona un servicio",
    presupuesto_contacto_ahorro: "¿Cuánto puedes ahorrar?",
    presupuesto_contacto_p: "Contáctanos para recibir un presupuesto personalizado y gratuito adaptado a tus necesidades energéticas.",
    presupuesto_contacto_email: "Email",
    presupuesto_contacto_email_p: "Explícanos tu situación o necesidades energéticas y te enviaremos una propuesta personalizada.",
    presupuesto_contacto_cliente: "Enviar correo",
    presupuesto_contacto_telefono: "Teléfono",
    presupuesto_contacto_telefono_p: "Te asesoramos directamente por teléfono y resolvemos tus dudas al instante.",
    presupuesto_contacto_llamar: "Llamar ahora",
    presupuesto_contacto_visitanos: "Visítanos",
    presupuesto_contacto_direccion: "Solicita una visita presencial en nuestras oficinas para recibir atención personalizada.",
    presupuesto_contacto_solicitar_visita: "Solicitar visita",
    // FAQ
  ...
  // Traducción al catalán
   ca: {
    ...
    contacto: "Contacte",
    presupuesto: "Rep el teu pressupost",
    ...
    servicios_subtitulo: "Descobreix <span class=\"naranja\">els nostres serveis</span> d’energia renovable",
    servicio_fotovoltaica_titulo: "Instal·lació Fotovoltaica",
    servicio_fotovoltaica_desc: "Oferim sistemes de panells solars personalitzats per a llars i empreses, optimitzats per a l’eficiència i l’estalvi.",
    servicio_aerotermia_titulo: "Aerotèrmia",
    servicio_aerotermia_desc: "Solucions d’aerotèrmia per a calefacció i refrigeració eficients, aprofitant l’energia de l’aire per reduir el consum.",
    servicio_calefaccion_titulo: "Calefacció",
    servicio_calefaccion_desc: "Instal·lem sistemes de calefacció ecològics i econòmics, adaptats a les necessitats de cada espai.",
    servicio_mantenimiento_titulo: "Manteniment",
    servicio_mantenimiento_desc: "Oferim plans de manteniment preventiu i correctiu per assegurar el rendiment òptim de les teves instal·lacions energètiques.",
    servicio_asesoramiento_titulo: "Assessorament",
    servicio_asesoramiento_desc: "Brindem assessorament expert per ajudar-te a prendre decisions informades sobre les teves necessitats energètiques.",
    satisfechos_titulo: "Clients Satisfets",
    experiencia_titulo: "Anys d'experiència",
    sostenibilidad_titulo: "Compromís amb la sostenibilitat",
    proyectos_titulo: "Projectes completats per mes",

    // sobre-nosotros.html
    sobre_titulo_pagina: "BefEnergy - Sobre nosaltres",
    sobre_titulo: "Sobre nosaltres",
    sobre_subtitulo: "Solucions <span class=\"naranja\">sostenibles i eficients</span> amb compromís i innovació.",
    ...
    contacto_facil_titulo: "Contacta’ns fàcilment",
    contacto_correo_titulo: "Correu electrònic",
    contacto_correo_email: "admin@befenergy.com",
    contacto_telefono_titulo: "Telèfon",
    contacto_telefono_num: "+34 93 131 56 36",
    contacto_direccion_titulo: "Adreça",
    contacto_direccion_texto: "Carrer d'Itàlia, 2, nau 2,<br>08700 Igualada, Barcelona",
    contacto_horario_titulo: "Horari",
    contacto_horario_lunes: "Dilluns a Divendres:",
    contacto_horario_semana: "7:00 – 13:00 | 15:00 – 17:00",
    contacto_horario_sabados: "Dissabtes i Diumenges:",
    contacto_horario_cerrado: "Tancat",
    contacto_prefieres_correo: "Prefereixes enviar-nos un correu?",
    contacto_btn_cliente: "Usar client de correu",
    contacto_btn_gmail: "Obrir Gmail",
    contacto_siguenos: "Segueix-nos a les xarxes socials!",

    // presupuesto-contacto.html
    presupuesto_contacto_titulo: "BefEnergy - Pressupost",
    presupuesto_contacto_hero_titulo: "Sol·licita el teu pressupost",
    presupuesto_contacto_hero_subtitulo: "T'ajudem a trobar la millor solució energètica per a tu.",
    presupuesto_contacto_form_titulo: "Formulari de Pressupost",
    presupuesto_contacto_form_nombre: "Nom",
    presupuesto_contacto_form_apellidos: "Cognoms",
    presupuesto_contacto_form_email: "Correu electrònic",
    presupuesto_contacto_form_telefono: "Telèfon",
    presupuesto_contacto_form_servicio: "Servei d'interès",
    presupuesto_contacto_form_servicio_placeholder: "Selecciona un servei",
    presupuesto_contacto_ahorro: "Quant pots estalviar?",
    presupuesto_contacto_p: "Contacta'ns per rebre un pressupost personalitzat i gratuït adaptat a les teves necessitats energètiques.",
    presupuesto_contacto_email: "Email",
    presupuesto_contacto_email_p: "Explícanos tu situación o necesidades energéticas y te enviaremos una propuesta personalizada.",
    presupuesto_contacto_cliente: "Enviar correo",
    presupuesto_contacto_telefono: "Teléfono",
  ...
  en: {
    ...
    servicios_subtitulo: "Discover <span class=\"naranja\">our renewable energy services</span>",
    servicio_fotovoltaica_titulo: "Photovoltaic Installation",
    servicio_fotovoltaica_desc: "We offer customized solar panel systems for homes and businesses, optimized for efficiency and savings.",
    servicio_aerotermia_titulo: "Aerothermal",
    servicio_aerotermia_desc: "Aerothermal solutions for efficient heating and cooling, harnessing air energy to reduce consumption.",
    servicio_calefaccion_titulo: "Heating",
    servicio_calefaccion_desc: "We install ecological and economical heating systems, adapted to the needs of each space.",
    servicio_mantenimiento_titulo: "Maintenance",
    servicio_mantenimiento_desc: "We offer preventive and corrective maintenance plans to ensure optimal performance of your energy installations.",
    servicio_asesoramiento_titulo: "Consulting",
    servicio_asesoramiento_desc: "We provide expert advice to help you make informed decisions about your energy needs.",
    satisfechos_titulo: "Satisfied Customers",
    experiencia_titulo: "Years of Experience",
    sostenibilidad_titulo: "Commitment to Sustainability",
    proyectos_titulo: "Projects Completed per Month",
    

    // sobre-nosotros.html
    sobre_titulo_pagina: "BefEnergy - About Us",
    sobre_titulo: "About Us",
    sobre_subtitulo: "Sustainable and efficient <span class=\"naranja\">solutions</span> with commitment and innovation.",
    ...
    contacto_facil_titulo: "Contact us easily",
    contacto_correo_titulo: "Email",
    contacto_correo_email: "admin@befenergy.com",
    contacto_telefono_titulo: "Phone",
    contacto_telefono_num: "+34 93 131 56 36",
    contacto_direccion_titulo: "Address",
    contacto_direccion_texto: "Carrer d'Itàlia, 2, nau 2,<br>08700 Igualada, Barcelona",
    contacto_horario_titulo: "Hours",
    contacto_horario_lunes: "Monday to Friday:",
    contacto_horario_semana: "7:00 – 13:00 | 15:00 – 17:00",
    contacto_horario_sabados: "Saturdays and Sundays:",
    contacto_horario_cerrado: "Closed",
    contacto_prefieres_correo: "Prefer to send us an email?",
    contacto_btn_cliente: "Use mail client",
    contacto_btn_gmail: "Open Gmail",
    contacto_siguenos: "Follow us on social media!",

    // presupuesto-contacto.html
    presupuesto_contacto_titulo: "BefEnergy - Quote",
    presupuesto_contacto_hero_titulo: "Request Your Quote",
    presupuesto_contacto_hero_subtitulo: "We help you find the best energy solution for you.",
    presupuesto_contacto_form_titulo: "Quote Form",
    presupuesto_contacto_form_nombre: "First Name",
    presupuesto_contacto_form_apellidos: "Last Name",
    presupuesto_contacto_form_email: "Email",
    presupuesto_contacto_form_telefono: "Phone",
    presupuesto_contacto_form_servicio: "Service of Interest",
    presupuesto_contacto_form_servicio_placeholder: "Select a service",
    presupuesto_contacto_ahorro: "How much can you save?",
    presupuesto_contacto_p: "Contact us to receive a personalized and free quote tailored to your energy needs.",
    presupuesto_contacto_email: "Email",
    presupuesto_contacto_email_p: "Tell us about your situation or energy needs.",
    presupuesto_contacto_cliente: "Email Client",
    presupuesto_contacto_gmail: "Gmail Web",
    presupuesto_contacto_telefono: "📞 Phone",
    presupuesto_contacto_telefono_p: "We advise you directly by phone.",
    presupuesto_contacto_llamar: "Call +34 93 131 56 36",
    presupuesto_contacto_visitanos: "📍 Visit Us",
    presupuesto_contacto_direccion: "Carrer d'Itàlia, 2, nau 2, 08700 Igualada, Barcelona",
    presupuesto_contacto_eslogan: "Be Green, be BEF.",
    presupuesto_contacto_eslogan_p: "Grow with us today.",
