...
const translations = {
    ...
    presupuesto_contacto_email_p: "Cuéntanos tu situación o necesidades energéticas.",
    presupuesto_contacto_cliente: "Cliente de correo",
    presupuesto_contacto_gmail: "Gmail Web",
    presupuesto_contacto_telefono: "📞 Teléfono",
    presupuesto_contacto_telefono_p: "Te asesoramos directamente por teléfono.",
    presupuesto_contacto_llamar: "Llama al +34 93 131 56 36",
    ...
    presupuesto_contacto_eslogan_p: "Crece con nosotros hoy.",
    // FAQ
  ...
  // Traducción al catalán
   ca: {
    ...
    presupuesto_contacto_email: "📧 Email",
    presupuesto_contacto_email_p: "Explica'ns la teva situació o necessitats energètiques.",
    presupuesto_contacto_cliente: "Client de correu",
    presupuesto_contacto_gmail: "Gmail Web",
    presupuesto_contacto_telefono: "📞 Telèfon",
    presupuesto_contacto_telefono_p: "T'assessorem directament per telèfon.",
    presupuesto_contacto_llamar: "Truca al +34 93 131 56 36",
    presupuesto_contacto_visitanos: "📍 Visita'ns",
    presupuesto_contacto_direccion: "Carrer d'Itàlia, 2, nau 2, 08700 Igualada, Barcelona",
    presupuesto_contacto_eslogan: "Be Green, be BEF.",
    presupuesto_contacto_eslogan_p: "Creix amb nosaltres avui.",
